...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    document.getElementById('add-property-btn').addEventListener('click', async function (e) {
        ...
        formData.append('repairType', document.getElementById('repair-type').value);
        ...
        formData.append('district_id', document.getElementById('district').value);
        formData.append('town_id', document.getElementById('town').value);
        formData.append('subway_id', document.getElementById('subway').value);
        ...
        formData.append('advertiser_name', document.getElementById('advertiser_name')?.value || '');
        formData.append('phone_1', document.getElementById('phone_1').value);
        formData.append('phone_2', document.getElementById('phone_2').value);
        formData.append('phone_3', document.getElementById('phone_3').value);
        formData.append('phone_4', document.getElementById('phone_4').value);
