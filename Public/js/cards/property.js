...
export function propertyCard(property) {
    ...
    return `<div
        ...
        class="cursor-pointer border border-[color:var(--border-color)] rounded-2xl overflow-hidden group relative transition-all duration-300"
        role="link" tabindex="0"
        onkeypress="if(event.key === 'Enter'){window.location.href='${detailUrl}'}"
    >
