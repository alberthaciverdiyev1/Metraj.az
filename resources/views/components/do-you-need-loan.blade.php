<div>
    <h2 class="text-4xl font-bold text-[var(--text-color)]">{{ __('Do you need a home loan?') }}<br />{{ __('Get pre-approved') }}</h2>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
        <label class="block text-sm font-medium text-gray-900 font-bold">{{ __('Total Amount') }}</label>
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700 font-bold">{{ __('Down Payment') }}</label>
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700 font-bold">{{ __('Interest Rate') }}</label>
        <input id="interestRate" type="text" data-type="number" value="5"
            class="mt-1 w-full rounded-xl border border-gray-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-400" />
    </div>
    <div>
        <label class="block text-sm font-medium text-gray-700 font-bold">{{ __('Amortization Period (years)') }}</label>
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700 font-bold">{{ __('Property Tax') }} ($/{{ __('year') }})</label>
        <input id="propertyTax" type="text" data-type="number" value="3000"
            class="mt-1 w-full rounded-xl border border-gray-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-400" />
    </div>
    <div>
        <label class="block text-sm font-medium text-gray-700 font-bold">{{ __('Home Insurance') }} ($/{{ __('year') }})</label>
...
<p class="text-gray-700 mt-4">{{ __('Your estimated monthly payment') }}: <span id="paymentDisplay"
        class="text-orange-500 font-bold">$0</span></p>
