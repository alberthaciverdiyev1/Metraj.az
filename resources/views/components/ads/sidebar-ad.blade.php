...
<aside class="hidden xl:block w-[220px] 2xl:w-[260px] 3xl:w-[300px] shrink-0 relative z-10 py-2">
    <div class="sticky top-[78px] z-10 h-[calc(100vh-88px)] w-full flex flex-col gap-2">
        <span class="text-[10px] font-bold uppercase tracking-[0.22em] text-gray-400 text-center select-none">
            — {{ $label }} —
        </span>

        <a href="{{ $href }}"
           class="group relative flex-1 w-full min-h-0 rounded-2xl overflow-hidden border border-gray-200/90 shadow-sm hover:shadow-lg transition duration-300">
            @if($isRight)
