<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
    <!-- Name -->
    <div>
        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('contact.full_name') }} <span class="text-rose-500">*</span></label>
    ...
    <!-- Phone -->
    <div>
        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('contact.contact_phone') }} <span class="text-rose-500">*</span></label>
    ...
    <!-- WhatsApp -->
    <div>
        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('contact.whatsapp_number') }}</label>
