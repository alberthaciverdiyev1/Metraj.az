<nav id="mobileBottomNav" class="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200/90 px-2 flex items-center justify-around select-none">
  ...
  <div class="flex flex-col items-center justify-center flex-1 relative -top-3.5">
    <a href="{{ route('add-property') }}" class="w-13 h-13 bg-[#f1913d] hover:bg-[#e07f2c] text-white rounded-full shadow-lg flex items-center justify-center border-4 border-white transition-all transform hover:scale-105 active:scale-95" title="{{ __('navbar.post_property') }}">
