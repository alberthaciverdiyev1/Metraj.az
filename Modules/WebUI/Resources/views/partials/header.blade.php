            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="header-elements">
                        <div class="site-logo">
                            <a href="index.html"><img src="{{asset('web/img/logo/logo1.png')}}" alt="housebox"></a>
                        </div>
                        <div class="main-menu">
                            <ul>
                                    ...
                                    <div class="tp-submenu">
                                                ...
                                                <div class="all-images-menu">
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            <div class="img1">
                                                                <img src="{{asset('web/img/all-images/demo/demo-img1.png')   }}"
                                                                     alt="housebox">
                                                            </div>

                                                            <div class="homemenu-btn">
                                                                <a class="theme-btn1" href="index.html">View Demo <span
                                                                        class="arrow1"><svg
                                        ...
                                        <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            <div class="img1">
                                                                <img src="{{asset('web/img/all-images/demo/demo-img2.png')}}"
                                                                     alt="housebox">
                                                            </div>
                                                            <div class="homemenu-btn">
                                                                <a class="theme-btn1" href="index2.html"> View Demo
                                        ...
                                        <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            <div class="img1">
                                                                <img src="{{asset('web/img/all-images/demo/demo-img3.png')}}"
                                                                     alt="housebox">
                                                            </div>
                                                            <div class="homemenu-btn">
                                                                <a class="theme-btn1" href="index3.html">View Demo <span
                                                                        class="arrow1"><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            viewBox="0 0 24 24" width="24" height="24"
                                                                            fill="currentColor">
                                        ...
                                        <path d="M12 13H4V11H12V4L20 12L12 20V13Z"></path>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            <div class="img1">
                                                                <img src="{{asset('web/img/all-images/demo/demo-img4.png')}}"
                                                                     alt="housebox">
                                                            </div>

                                                            <div class="homemenu-btn">
                                                                <a class="theme-btn1" href="index4.html">View Demo <span
                                                                        class="arrow1"><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            viewBox="0 0 24 24" width="24" height="24"
                                                                            fill="currentColor">
                        ...
                        <div class="btn-area">
                            ...
                            <a href="property-halfmap-grid.html" class="theme-btn1">View Listing <span class="arrow1"><svg
