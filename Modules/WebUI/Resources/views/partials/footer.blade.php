        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="footer-logoarea">
                    <img src="{{asset('web/img/logo/logo1.png')}}" alt="housebox">
                ...
                <div class="footer-content2">
                    ...
                    <ul>
                        ...
                        <li><a href="#">
                                ...
                                421 Allen, Mexico 4233</a></li>

                        <li><a href="mailto:houseboxesate.com">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                    <path
                ...
                <div class="instagram-posts">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-4">
                            <div class="img1">
                                <img src="{{asset('web/img/all-images/footer/footer-img1.png')}}" alt="housebox">
                                <div class="icons">
                        ...
                        <div class="col-lg-4 col-4">
                            <div class="img1">
                                <img src="{{asset('web/img/all-images/footer/footer-img2.png')}}" alt="housebox">
                                <div class="icons">
                                    <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-4">
                            <div class="img1">
                                <img src="{{asset('web/img/all-images/footer/footer-img3.png')}}" alt="housebox">
                                <div class="icons">
                                    <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-4">
                            <div class="img1">
                                <img src="{{asset('web/img/all-images/footer/footer-img4.png')}}" alt="housebox">
                                <div class="icons">
                                    <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-4">
                            <div class="img1">
                                <img src="{{asset('web/img/all-images/footer/footer-img5.png')}}" alt="housebox">
                                <div class="icons">
                                    <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-4">
                            <div class="img1">
                                <img src="{{asset('web/img/all-images/footer/footer-img6.png')}}" alt="housebox">
                                <div class="icons">
                                    <a href="#"><i class="fa-brands fa-instagram"></i></a>
                                </div>
                            </div>
